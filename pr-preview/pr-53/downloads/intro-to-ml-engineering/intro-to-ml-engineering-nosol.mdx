...
Lecture notes and materials for Lecture 1a self-contained within this repository: [https://github.com/iliad-team/iliad-intensive-C.1.1](https://github.com/iliad-team/iliad-intensive-C.1.1)
