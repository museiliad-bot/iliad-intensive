...
summary: >- 
  What can we learn about how a model works by looking at its internals? 
  We cover the main methods for reverse engineering neural networks, 
  from features and circuits to sparse autoencoders and auto-interp
  of activations, and discuss the relevance to safety.
contributors:
