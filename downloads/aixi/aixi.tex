...
\begin{itemize}\itemsep=2pt
    ...
    \item $\cH \equiv \cH^*$: set of all finite histories
...
\begin{itemize}\itemsep=2pt
    ...
    \item \textbf{Monotone limits:} if $A_1 \supseteq A_2 \supseteq \cdots$, then $\nu^\pi\!\big(\bigcap_{n=1}^\infty A_n\big) = \lim_{n \to \infty} \nu^\pi(A_n)$.
\end{itemize}
