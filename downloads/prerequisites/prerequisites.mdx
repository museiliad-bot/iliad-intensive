...
* Reinforcement learning:
  ...
  * Value functions, Bellmann equations, and optimal policies
  ...
  → [Sutton and Barto’s book](http://incompleteideas.net/book/RLbook2020.pdf) on reinforcement learning is an excellent introduction to general RL. [D.1.2: Reinforcement Learning](https://iliad-team.github.io/iliad-intensive/agency/reinforcement-learning/) also provides many of these definitions in
  a convenient place.
