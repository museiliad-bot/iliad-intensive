...
- [1. Introduction: the role of thermodynamics in agent foundations](#1-introduction-the-role-of-thermodynamics-in-agent-foundations)
- [2. Theoretical foundations: probability, entropy, and information](#2-theoretical-foundations-probability-entropy-and-information)
  - [2.1 Random variables and notation](#21-random-variables-and-notation)
  - [2.2 Entropy](#22-entropy)
  - [2.3 The coding interpretation](#23-the-coding-interpretation)
  - [2.4 Joint and conditional entropy, and mutual information](#24-joint-and-conditional-entropy-and-mutual-information)
  - [2.5 Divergence and two fundamental inequalities](#25-divergence-and-two-fundamental-inequalities)
- [3. Characterizing optimization](#3-characterizing-optimization)
  - [3.1 Two notions of optimization and their relationship](#31-two-notions-of-optimization-and-their-relationship)
  - [3.2 Optimizers and convergent attractors](#32-optimizers-and-convergent-attractors)
  - [3.3 Optimization as entropy reduction](#33-optimization-as-entropy-reduction)
  - [3.4 The predictive value of optimizers](#34-the-predictive-value-of-optimizers)
  - [3.5 The observer-independence of optimization](#35-the-observer-independence-of-optimization)
- [4. Reversibility and the second law](#4-reversibility-and-the-second-law)
  - [4.1 The reversibility of microscopic physics](#41-the-reversibility-of-microscopic-physics)
  - [4.2 The incompatibility of global funneling with reversibility](#42-the-incompatibility-of-global-funneling-with-reversibility)
  - [4.3 Coarse-graining and the emergence of probability](#43-coarse-graining-and-the-emergence-of-probability)
  - [4.4 The second law of thermodynamics](#44-the-second-law-of-thermodynamics)
  - [4.5 The scope and limitations of the second law](#45-the-scope-and-limitations-of-the-second-law)
- [5. Three types of optimization under information conservation](#5-three-types-of-optimization-under-information-conservation)
  - [5.1 The bookkeeping problem](#51-the-bookkeeping-problem)
  - [5.2 Type 1: transfer of entropy into the environment as waste heat](#52-type-1-transfer-of-entropy-into-the-environment-as-waste-heat)
  - [5.3 Type 2: absorption of entropy into the agent's memory through measurement](#53-type-2-absorption-of-entropy-into-the-agents-memory-through-measurement)
  - [5.4 Type 3: expenditure of pre-existing mutual information](#54-type-3-expenditure-of-pre-existing-mutual-information)
  - [5.5 A reinterpretation of Maxwell's demon, and a synthesis of the three channels](#55-a-reinterpretation-of-maxwells-demon-and-a-synthesis-of-the-three-channels)
- [6. Limitations of subjective entropy](#6-limitations-of-subjective-entropy)
  - [6.1 Entropy as a measure of optimization capacity](#61-entropy-as-a-measure-of-optimization-capacity)
  - [6.2 The exogenous status of the reference distribution](#62-the-exogenous-status-of-the-reference-distribution)
  - [6.3 Three failure modes of the ensemble formalism](#63-three-failure-modes-of-the-ensemble-formalism)
  - [6.4 The demon's capacity as the central case for agent foundations](#64-the-demons-capacity-as-the-central-case-for-agent-foundations)
- [7. Algorithmic thermodynamics](#7-algorithmic-thermodynamics)
  - [7.1 Kolmogorov complexity](#71-kolmogorov-complexity)
  - [7.2 Justification of $K$ as an entropy measure](#72-justification-of-k-as-an-entropy-measure)
  - [7.3 The algorithmic second law](#73-the-algorithmic-second-law)
  - [7.4 An exact analysis of Maxwell's demon](#74-an-exact-analysis-of-maxwells-demon)
- [8. Knowledge as a physical resource: optimization for embedded agents](#8-knowledge-as-a-physical-resource-optimization-for-embedded-agents)
  - [8.1 From exogenous to endogenous knowledge](#81-from-exogenous-to-endogenous-knowledge)
  - [8.2 Refinements of the three channels via universal computation](#82-refinements-of-the-three-channels-via-universal-computation)
  - [8.3 Dissolution of the apparent subjectivity](#83-dissolution-of-the-apparent-subjectivity)
  - [8.4 Thermodynamic implications for optimizing systems](#84-thermodynamic-implications-for-optimizing-systems)
- [9. Summary and conclusions](#9-summary-and-conclusions)
- [A. A thermodynamics of biased coins: the generalized heat engine](#a-a-thermodynamics-of-biased-coins-the-generalized-heat-engine)
  - [A.1 The designer's viewpoint](#a1-the-designers-viewpoint)
  - [A.2 Specification of the model: coins, transformations, and conservation laws](#a2-specification-of-the-model-coins-transformations-and-conservation-laws)
  - [A.3 Work extraction as a compression problem](#a3-work-extraction-as-a-compression-problem)
  - [A.4 The impossibility of work extraction from a single heat bath](#a4-the-impossibility-of-work-extraction-from-a-single-heat-bath)
  - [A.5 Work extraction from two heat baths at different temperatures](#a5-work-extraction-from-two-heat-baths-at-different-temperatures)
  - [A.6 Lessons from the toy world](#a6-lessons-from-the-toy-world)
- [B. The informational cost of steering: the Touchette–Lloyd theorem](#b-the-informational-cost-of-steering-the-touchettelloyd-theorem)
  - [B.1 From optimization to modeling: the motivating question](#b1-from-optimization-to-modeling-the-motivating-question)
  - [B.2 The formal setup: environments, actions, and policies](#b2-the-formal-setup-environments-actions-and-policies)
  - [B.3 Blind and sighted policies](#b3-blind-and-sighted-policies)
  - [B.4 A worked example: the guessing game under blind play](#b4-a-worked-example-the-guessing-game-under-blind-play)
  - [B.5 The guessing game under sighted play](#b5-the-guessing-game-under-sighted-play)
  - [B.6 Mutual information as a measure of sightedness](#b6-mutual-information-as-a-measure-of-sightedness)
  - [B.7 Statement of the theorem](#b7-statement-of-the-theorem)
  - [B.8 Limitations of the theorem](#b8-limitations-of-the-theorem)
...
We begin by recalling the function that entropy serves: across physics and engineering, the role of entropy is to measure a system's capacity to do work, and the developments of [Sections 4–5](#4-reversibility-and-the-second-law), together with the coin world of [Appendix A](#a-a-thermodynamics-of-biased-coins-the-generalized-heat-engine), permit us to read "capacity to do work" as *capacity to optimize*: negentropy constitutes the fuel that funnels broad distributions into narrow ones.
...
$$
\begin{gathered}K(s \mid a) \;\plt\; \log \frac{1}{q(s)}, \qquad\text{and hence}\\ I(a : s) \;\peq\; K(s) - K(s \mid a) \;\pgt\; K(s) - \log \frac{1}{q(s)}.\end{gathered}
$$
...
$$
\begin{gathered}P(Y = \texttt{00000}) = \tfrac{2}{32}= \tfrac1{16}, \qquad P(Y = \texttt{11111}) = 0,\\ P(Y = y) = \tfrac1{32}\;\text{ for the other 30 strings},\end{gathered}
$$
